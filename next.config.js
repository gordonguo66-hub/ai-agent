    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://vercel.live https://va.vercel-scripts.com https://us-assets.i.posthog.com",
              "style-src 'self' 'unsafe-inline'",
              "img-src 'self' data: https: blob:",
              "font-src 'self' data:",
              "connect-src 'self' https://*.supabase.co https://api.hyperliquid.xyz https://api.coinbase.com https://api.pro.coinbase.com https://api.exchange.coinbase.com https://advanced-trade-ws.coinbase.com https://api.stripe.com https://api.openai.com https://api.anthropic.com https://api.deepseek.com https://generativelanguage.googleapis.com https://api.x.ai https://dashscope.aliyuncs.com https://us.i.posthog.com https://us-assets.i.posthog.com wss://*.supabase.co",
