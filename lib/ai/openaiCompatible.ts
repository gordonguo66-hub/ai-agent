...
export async function openAICompatibleIntentCall(args: {
  ...
  const system = [
    ...
    "",
    "⚠️ EXIT MANAGEMENT (CRITICAL):",
    "When you're in a position, decide whether to hold or close based on ALL available data.",
    "- Analyze indicators, price action, volume, news — use everything at your disposal",
    "- Lock in profits when you detect the price is likely to reverse against your position",
    "- Cut losses when your entry thesis is invalidated",
    "",
